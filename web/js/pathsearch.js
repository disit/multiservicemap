...
function doSearchPath(v, fit) {
  ...
  if(!v) {
    $.ajax({
          ...
          url: selectedorgUrl+ctx+"shortestpath/",
          type: "GET",
          ...
          success: function (response) {
            ...
            document.getElementById('savePathSearch').removeAttribute('disabled','disabled');
            document.getElementById('savePathSearch').src="img/save_enable.png";
            document.getElementById('savePathSearch').style.cursor="pointer"; 
